...
#define  tt0007_ENCRYPT_CUST_EDP_LEN   17
#define  tt0007_PO_NUM_LEN                         20
#define  tt0007_FLAG_LEN                           1
...
#define  tt0007_LINE_ITEM_COUNT        250
...
typedef struct
{
    ...
    char encrypt_cust_edp[tt0007_ENCRYPT_CUST_EDP_LEN+1];
        char po_number[tt0007_PO_NUM_LEN+1];
        char search_type[tt0007_FLAG_LEN+1];
...
typedef struct
{
    ...
    char item_price[tt0007_ITM_PRICE_LEN+1];
        char item_gift_cert[tt0007_GFT_CERT_LEN+1];
    char item_type[tt0007_ITM_TYPE_LEN+1];
