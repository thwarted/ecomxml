...
//      ap_rprintf(r,"%s",stdout_buffer); return 0;
        switch(tttype)
        {
                ...
                case 119:                       
                        ...
                        if((fill_working_struct(gbp,stdout_buffer)) != 0)
                                return(-2);
                        if((tt0119_end(r,gbp,stdout_buffer)) != 0)
                                return(-3);
                        return(1);
                break;
                ...
                case 121:                       
                        ...
                        if((fill_working_struct(gbp,stdout_buffer)) != 0)
                                return(-2);
                        if((tt0121_end(r,gbp,stdout_buffer)) != 0)
                                return(-3);
                        return(1);
                break;
                ...
                case 125:                       
                        ...
                        if((fill_working_struct(gbp,stdout_buffer)) != 0)
                                return(-2);
                        if((tt0125_end(r,gbp,stdout_buffer)) != 0)
                                return(-3);
                        return(1);
                break;
                ...
                case 129:                       
                        if((tt0129_start(gbp)) != 0)
                                return(-1);
                        if((fill_working_struct(gbp,stdout_buffer)) != 0)
                                return(-2);
                        if((tt0129_end(r,gbp,stdout_buffer)) != 0)
                                return(-3);
                        return(1);
                break;

                case 131:                       
                        if((tt0131_start(gbp)) != 0)
                                return(-1);
                        if((fill_working_struct(gbp,stdout_buffer)) != 0)
                                return(-2);
