...
int tt0025_CatSendStr(struct global_struct *gbp, char *sendbufcat, tt0025_st_send *sendbuf)
{
    ...
    gbp->j = sprintf(sendbufcat,
			...
			sendbuf->filler,
			sendbuf->page_no,
            atoi(sendbuf->modify_line_num[0]),
            atoi(sendbuf->modify_new_qty[0]),
			atoi(sendbuf->modify_line_num[1]),
            atoi(sendbuf->modify_new_qty[1]),
			atoi(sendbuf->modify_line_num[2]),
            atoi(sendbuf->modify_new_qty[2]),
			atoi(sendbuf->modify_line_num[3]),
            atoi(sendbuf->modify_new_qty[3]),
			atoi(sendbuf->modify_line_num[4]),
            atoi(sendbuf->modify_new_qty[4]),
			atoi(sendbuf->modify_line_num[5]),
            atoi(sendbuf->modify_new_qty[5]),
			atoi(sendbuf->modify_line_num[6]),
            atoi(sendbuf->modify_new_qty[6]),
			atoi(sendbuf->modify_line_num[7]),
            atoi(sendbuf->modify_new_qty[7]),
			atoi(sendbuf->modify_line_num[8]),
            atoi(sendbuf->modify_new_qty[8]),
			atoi(sendbuf->modify_line_num[9]),
            atoi(sendbuf->modify_new_qty[9]),
			atoi(sendbuf->modify_line_num[10]),
            atoi(sendbuf->modify_new_qty[10]),
			atoi(sendbuf->modify_line_num[11]),
            atoi(sendbuf->modify_new_qty[11]),
			atoi(sendbuf->modify_line_num[12]),
            atoi(sendbuf->modify_new_qty[12]),
			atoi(sendbuf->modify_line_num[13]),
            atoi(sendbuf->modify_new_qty[13]),
			atoi(sendbuf->modify_line_num[14]),
            atoi(sendbuf->modify_new_qty[14]),
			atoi(sendbuf->modify_line_num[15]),
            atoi(sendbuf->modify_new_qty[15]),
			atoi(sendbuf->modify_line_num[16]),
            atoi(sendbuf->modify_new_qty[16]),
			atoi(sendbuf->modify_line_num[17]),
            atoi(sendbuf->modify_new_qty[17]),
			atoi(sendbuf->modify_line_num[18]),
            atoi(sendbuf->modify_new_qty[18]),
			atoi(sendbuf->modify_line_num[19]),
            atoi(sendbuf->modify_new_qty[19]),
            atoi(sendbuf->modify_line_num[20]),
            atoi(sendbuf->modify_new_qty[20]),
			atoi(sendbuf->modify_line_num[21]),
            atoi(sendbuf->modify_new_qty[21]),
			atoi(sendbuf->modify_line_num[22]),
            atoi(sendbuf->modify_new_qty[22]),
			atoi(sendbuf->modify_line_num[23]),
            atoi(sendbuf->modify_new_qty[23]),
			atoi(sendbuf->modify_line_num[24]),
            atoi(sendbuf->modify_new_qty[24]),
			atoi(sendbuf->modify_line_num[25]),
            atoi(sendbuf->modify_new_qty[25]),
			atoi(sendbuf->modify_line_num[26]),
            atoi(sendbuf->modify_new_qty[26]),
			atoi(sendbuf->modify_line_num[27]),
            atoi(sendbuf->modify_new_qty[27]),
			atoi(sendbuf->modify_line_num[28]),
            atoi(sendbuf->modify_new_qty[28]),
			atoi(sendbuf->modify_line_num[29]),
            atoi(sendbuf->modify_new_qty[29]),
            atoi(sendbuf->modify_line_num[30]),
            atoi(sendbuf->modify_new_qty[30]),
			atoi(sendbuf->modify_line_num[31]),
            atoi(sendbuf->modify_new_qty[31]),
			atoi(sendbuf->modify_line_num[32]),
            atoi(sendbuf->modify_new_qty[32]),
			atoi(sendbuf->modify_line_num[33]),
            atoi(sendbuf->modify_new_qty[33]),
			atoi(sendbuf->modify_line_num[34]),
            atoi(sendbuf->modify_new_qty[34]),
			atoi(sendbuf->modify_line_num[35]),
            atoi(sendbuf->modify_new_qty[35]),
			atoi(sendbuf->modify_line_num[36]),
            atoi(sendbuf->modify_new_qty[36]),
			atoi(sendbuf->modify_line_num[37]),
            atoi(sendbuf->modify_new_qty[37]),
			atoi(sendbuf->modify_line_num[38]),
            atoi(sendbuf->modify_new_qty[38]),
			atoi(sendbuf->modify_line_num[39]),
            atoi(sendbuf->modify_new_qty[39]),
            atoi(sendbuf->modify_line_num[40]),
            atoi(sendbuf->modify_new_qty[40]),
			atoi(sendbuf->modify_line_num[41]),
            atoi(sendbuf->modify_new_qty[41]),
			atoi(sendbuf->modify_line_num[42]),
            atoi(sendbuf->modify_new_qty[42]),
			atoi(sendbuf->modify_line_num[43]),
            atoi(sendbuf->modify_new_qty[43]),
			atoi(sendbuf->modify_line_num[44]),
            atoi(sendbuf->modify_new_qty[44]),
			atoi(sendbuf->modify_line_num[45]),
            atoi(sendbuf->modify_new_qty[45]),
			atoi(sendbuf->modify_line_num[46]),
            atoi(sendbuf->modify_new_qty[46]),
			atoi(sendbuf->modify_line_num[47]),
            atoi(sendbuf->modify_new_qty[47]),
			atoi(sendbuf->modify_line_num[48]),
            atoi(sendbuf->modify_new_qty[48]),
			atoi(sendbuf->modify_line_num[49]),
            atoi(sendbuf->modify_new_qty[49])
			);
