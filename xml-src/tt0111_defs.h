...
#define  tt0111_LAN_SEND_BUF_LEN       82    //77     
#define  tt0111_LAN_RECV_BUF_LEN       10330  
...
#define  tt0111_PAGE_NO_LEN                        2
#define  tt0111_LINE_NO_LEN                        3
...
typedef struct
{
    ...
    char ip_address[tt0111_IP_ADDR_LEN+1];
        ...
        char page_no[tt0111_PAGE_NO_LEN+1];
        char line_no[tt0111_LINE_NO_LEN+1];
