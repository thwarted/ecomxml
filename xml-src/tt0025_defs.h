...
#define  tt0025_LAN_RECV_BUF_LEN       8150 //7950
...
#define  tt0025_ITM_AVAIL_INV_LEN          7
...
#define  tt0025_GWRAP_AVAIL_INV_LEN        7
#define  tt0025_FRM_QTY_LEN                        5
#define  tt0025_PRICE_OVRD_FLAG_LEN    1
...
typedef struct
{
    ...
    char stand_ord_item[tt0025_STAND_ORD_ITEM_LEN+1];
        ...
        char price_ovrd_flag[tt0025_PRICE_OVRD_FLAG_LEN+1];
